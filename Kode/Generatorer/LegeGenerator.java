...
/**
 * Denne klassen er til for å generere legeobjekter til e-resept-sytemet. 
...
public class LegeGenerator {
    ...
    private final String[] arbeidstedEtternavn = {"legesenter", "sykehus"};
    private final char[] passord = {'1', '2', '3', '4'};
