...
public class Navngenerator {
    ...
    private final char[] vok, kon, dobble, vokAlene, konSlutt, ikkeSlutt;
    ...
    /* Lager et nytt navn bestående av to feks fornavn og etternavn. Returneres som en String.*/
    ...
    /*Returnerer et String-array mee så mange navn som man sender med som parameter. 
     Ett dobbeltnavn per indeksplass*/
    ...
    /*Lager og returnerer et navn på mellom 3 og 9 bokstaver.*/
    public String genererNavn() {
        ...
        for (int i = 0; i < lengde; i++) {
            ...
            } else // så trekk konsonant
            {
                ...
                navn += kon[k];
                //setter 25% sjangse for at kosonanten skal gi en dobbeltkonsonant.
    ...
    private boolean iVokalAlene(char c) {
    ...
    private boolean iDobble(char c) {
    ...
    private boolean iIkkeDobbelSlutt(char c) {
    ...
    private boolean iIkkeSlutt(char c) {
